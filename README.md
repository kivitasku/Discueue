...
### Data import
- Data import is currently run as with /api/music/import with the user_id being 1 for authentication or with the run-import.sh

- Data is generated through song metadata

#### Import structure
- Grouping albums by artist is optional, only album cover image paths are generated by song filepath
```bash
